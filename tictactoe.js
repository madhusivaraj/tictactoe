...
function Board (options){
  ...
  function render(){
    ...
    function htmlQ1(){
      return `<div id="view1"><h1>Tic Tac Toe\n\n\n</h1><h3>You won't beat me. But you can try.\n</h3>
      ${buttonHTML(1, "1player", "Game On")}
      </div>`
    }
    ...
    function htmlGame (){
      const moveNumber = countMoves(state.game._gameBoard) + 1
